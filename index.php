...
<body>
    ...
    <div class="cari">
      <div class="conten">
        <form action="produk.php">
          <input type="text" name="cari" placeholder="Cari" id="">
      ...
      <div class="box">
        ...
        ?>
            <a href="produk.php?kat=<?php echo $k['kategori_id'] ?>">
              <div class="col-5">
                <img src="img/kranjang.jpg" alt="" width="50px" style="margin-bottom: 5px;">
  ...
  <div class="section">
    <div class="kontener">
      ...
      <div class="box">
        <?php
        $produk = mysqli_query($koneksi, "SELECT * FROM tb_produk ORDER BY produk_id DESC ");
